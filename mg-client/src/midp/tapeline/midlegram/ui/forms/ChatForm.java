...
public class ChatForm extends UIForm {
    ...
    Command last = new Command("Last", Command.SCREEN, 1);
    ...
    StringItem lastButton = new StringItem("", "Latest", Item.BUTTON);
    ...
    static class ChatMessagePoller implements Runnable {
        ...
        void start() {
            if (form.currentAnchor != 0) return;
            th = new Thread(this);
            running = true;
            th.start();
        }
